...
public class Cell implements Drawable {
	 ...
	 */
	public void liveOrDie(int numNeighbors, Cell cell) {
		if (cell.isAlive == true && numNeighbors < 2) {
			cell.isAlive = false;
		}
		if (cell.isAlive == true && numNeighbors == 2) {
			cell.isAlive = true;
		}
		if (cell.isAlive == true && numNeighbors == 3) {
			cell.isAlive = true;
		}
		if (cell.isAlive == true && numNeighbors > 3) {
			cell.isAlive = false;
		}
		if (cell.isAlive == false && numNeighbors == 3) {
			cell.isAlive = true;
		}
	}
